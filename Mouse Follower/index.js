...
class Particule{
    ...
    update(){
        ...
        this.lastPoints.x += (mouse.x - this.lastPoints.x) ;
        this.lastPoints.y += (mouse.y - this.lastPoints.y) ;

        this.x = this.lastPoints.x + Math.cos(this.radian) ;
        this.y = this.lastPoints.y + Math.sin(this.radian) ;
        this.draw();
    }
}
